        ...
        },
        {
            ...
            click() {
                if (state_js_1.state.player.isPlaying) {
                    (0, events_js_1.sendPlayerAction)(window, playerActions_js_1.PlayerActions.PAUSE);
                } else {
                    (0, events_js_1.sendPlayerAction)(window, playerActions_js_1.PlayerActions.PLAY);
                }
            },
        },
        {
            label: (0, formatters_js_1.formatMessage)({ id: 'player-actions.previous-track' }),
            enabled: state_js_1.state.player.canMoveBackward,
            click() {
                (0, events_js_1.sendPlayerAction)(window, playerActions_js_1.PlayerActions.MOVE_BACKWARD);
            },
        },
        {
            label: (0, formatters_js_1.formatMessage)({ id: 'player-actions.next-track' }),
            enabled: state_js_1.state.player.canMoveForward,
            click() {
                (0, events_js_1.sendPlayerAction)(window, playerActions_js_1.PlayerActions.MOVE_FORWARD);
            },
        },
        {
            type: 'separator',
        },
        {
            ...
            submenu: [
                ...
                },
                {
                    ...
                    click() {
                        electron_1.shell.openExternal((0, supportChat_js_1.createSupportChatUrl)());
                    },
                },
            ],
        },
