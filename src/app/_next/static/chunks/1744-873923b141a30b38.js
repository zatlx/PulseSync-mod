    ...
    [1744],
    {
        ...
        23460: (e, t, i) => {
            ...
            var r = i(33008),
                ...
                v = i.n(g);
            let E = (e) => {
                let { closeToast: t, entityVariant: i, entityTitle: n, coverUri: a, variant: l } = e,
                    g = (0, s.useMemo)(
                        () =>
                            (0, r.jsxs)(d.Caption, {
                        ...
                        switch (l) {
                            case m.N.NEXT:
                                return ((e, t) => {
                                    switch (e) {
                                        case c.cp.TRACK:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.track-will-be-played-next', values: { title: t } });
                                        case c.cp.PODCAST_EPISODE:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.podcast-episode-will-be-played-next', values: { title: t } });
                                        case c.cp.AUDIOBOOK_EPISODE:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.audiobook-episode-will-be-played-next', values: { title: t } });
                                    }
                                })(i, g);
                            case m.N.LAST:
                                return ((e, t) => {
                                    switch (e) {
                                        case c.cp.TRACK:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.track-will-be-played-last', values: { title: t } });
                                        case c.cp.PODCAST_EPISODE:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.podcast-episode-will-be-played-last', values: { title: t } });
                                        case c.cp.AUDIOBOOK_EPISODE:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.audiobook-episode-will-be-played-last', values: { title: t } });
                                    }
                                })(i, g);
                            case m.N.HIDE:
                            case m.N.REMOVE:
                                return ((e, t) => {
                                    switch (e) {
                                        case c.cp.TRACK:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.track-will-be-removed', values: { title: t } });
                                        case c.cp.PODCAST_EPISODE:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.podcast-episode-will-be-removed', values: { title: t } });
                                        case c.cp.AUDIOBOOK_EPISODE:
                                            return (0, r.jsx)(o.A, { id: 'play-queue.audiobook-episode-will-be-removed', values: { title: t } });
                                    }
                                })(i, g);
                        }
                    }, [l, i, g]);
                return (0, r.jsx)(c.$W, {
                    ...
                    cover: (0, r.jsx)(c.BW, { className: v().image, src: a, size: 100, fit: 'cover', alt: n, withAvatarReplace: !0 }),
                    closeToast: t,
                    coverRadius: 's',
                });
            };
            ...
            function y(e, t, i) {
                ...
                return (0, n.c)(() => {
                    ...
                    switch (t) {
                        case m.N.LAST:
                            null == u || u.injectLast({ entitiesData: [{ type: a.z4.Unloaded, meta: { id: e.entityId } }] });
                            break;
                        case m.N.NEXT:
                            null == u || u.injectNext({ entitiesData: [{ type: a.z4.Unloaded, meta: { id: e.entityId } }] });
                            break;
                        case m.N.REMOVE:
                            i && (null == u || u.removeAndLoadEntities({ positions: i }));
                            break;
                        case m.N.HIDE:
                            (null == i ? void 0 : i.length) && (null == u || u.hide({ positions: i }));
                    }
                    let n = o.modal.isOpened ? l.uQT.FULLSCREEN_INFO : l.uQT.INFO;
                    s((0, r.jsx)(E, { entityVariant: d, variant: t, entityTitle: e.title, coverUri: e.coverUri }), { containerId: n });
                });
            }
        },
        26557: (e, t, i) => {
                ...
                return (0, a.c)(async () => {
                    if ((!c || (null == e ? void 0 : e.isLiked) || (u ? i.open() : o.open()), t.isAuthorized) && e) {
                        if (!e.isLiked) {
                            ...
                            d.sendLikeFeedback({
                                reaction: n.g.LIKE,
                                yclid: null != (r = g.get(l.K3F.YCLID)) ? r : '',
                                campaignId: null != (a = g.get(l.K3F.UTM_CAMPAIGN)) ? a : '',
                                trackId: e.id,
                            });
                        }
                        return m({
        ...
        37259: (e, t, i) => {
            ...
            let a = (e, t) => {
                ...
                return i(
                    ...
                    { progress: Math.round((e / t) * 100), beginHours: a, beginMinutes: l, beginSeconds: s, endHours: o, endMinutes: u, endSeconds: d },
                );
            };
        },
        42054: (e, t, i) => {
            ...
            let v = () => {
                ...
                return (0, d.c)(async (a) => {
                    let { track: l, withLink: d = !0, infoContainerId: c, errorContainerId: p, withNotification: y = !0, playbackId: f } = a;
                    if (t) return;
                    ...
                    y &&
                        (I === o.f.OK
                            ? e((0, r.jsx)(g.NotificationLike, { withLink: d, track: h }), { containerId: c })
                            : e((0, r.jsx)(m.hT, { error: v({ id: 'error-messages.error-during-action' }) }), { containerId: p }));
                });
            };
        },
        47635: (e, t, i) => {
        ...
        49358: (e, t, i) => {
            ...
            let d = (e) => {
                ...
                return (0, s.c)(async () => {
                    if (!e) return;
                    let n = i.modal.isOpened ? o.uQT.FULLSCREEN_ERROR : o.uQT.ERROR;
                    if (!t.isAuthorized) return void m((0, r.jsx)(u.hT, { error: g({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: n });
                    let s = e.streamProgress,
                        E = (null == d ? void 0 : d.id) === e.id && (null == d ? void 0 : d.albumId) === e.albumId;
                    if ((await e.setListeningFinishedStatus()) !== l.T.OK)
                        m((0, r.jsx)(u.hT, { error: g({ id: 'error-messages.error-during-action' }) }), { containerId: n });
                    else {
                        var p, y;
                        let t = !(null == s ? void 0 : s.hasEverFinished),
                            i = null == v ? void 0 : v.state.queueState.entityList.value,
                            r =
                                null == i
                                    ? void 0
                                    : i.find((t) => {
                                          ...
                                          if ((0, a.b)(i)) {
                                              var r, n;
                                              let t = i.data.meta;
                                              return t.realId === e.id && (null == (n = t.albums) || null == (r = n[0]) ? void 0 : r.id) === e.albumId;
                                          }
                                          return !1;
                                      });
                        r && (r.entity.everFinished = !!t),
                            ...
                            (null == (y = c.meta) ? void 0 : y.listeningFinished) &&
                                !t &&
        ...
        61744: (e, t, i) => {
            ...
            let o = (e, t) => {
                    ...
                    return (0, l.wg)({
                        ...
                        albumId: null == (o = e.albums) || null == (a = o[0]) ? void 0 : a.id,
                ...
                u = (e, t) => {
                    if (!t) {
                        let { href: t } = (0, s.uvd)('/track/:trackId', { params: { trackId: e } });
                        return t;
                    }
                    let { href: i } = (0, s.uvd)('/album/:albumId/track/:trackId', { params: { albumId: t, trackId: e } });
                    return i;
                },
            ...
            var L = i(93435),
                T = i(59615),
                A = i(72315);
            let _ = l.gK.model('StreamProgress', { endPositionSec: l.gK.maybe(l.gK.number), hasEverFinished: l.gK.maybe(l.gK.boolean) }).actions((e) => ({
                    ...
                    markListened: (0, l.L3)(function* (t) {
                        let { streamsResource: i, modelActionsLogger: r } = (0, l._$)(e);
                        try {
                ...
                S = l.gK.model('TrackMajor', { id: l.gK.maybeNull(l.gK.number), name: l.gK.maybeNull(l.gK.string) }),
                ...
                N = l.gK
                    .compose(
                        l.gK.model('BaseTrack', {
                            ...
                            title: l.gK.string,
                            trackSource: l.gK.maybe(l.gK.enumeration(Object.values(n))),
                    ...
                    .views((e) => {
                        let t = {
                            ...
                            get isTrackAudiobook() {
                                if ((0, l._n)(e)) return e.type === O.S.AUDIOBOOK;
                                return !1;
                            },
                            get isTrackFairyTale() {
                                if ((0, l._n)(e)) return e.type === O.S.FAIRY_TALE;
                                return !1;
                            },
                            get isTrackNonMusic() {
                            ...
                            get isTrackMusic() {
                                if ((0, l._n)(e)) return e.type === O.S.TRACK || e.type === O.S.MUSIC;
                                return !1;
                            },
                            get isUGC() {
                                if ((0, l._n)(e)) return e.trackSource === n.UGC;
                                return;
                            },
                            get isOwn() {
                                if ((0, l._n)(e)) return e.trackSource === n.OWN;
                                return;
                            },
                            get isOwnReplacedToUGC() {
                                if ((0, l._n)(e)) return e.trackSource === n.OWN_REPLACED_TO_UGC;
                                return;
                            },
                            get seeds() {
                            ...
                            get modalDisclaimerId() {
                                if (e.disclaimers) {
                                    var i;
                                    let t = null == (i = (0, s.bRW)(e.disclaimers, L.M.MODAL)) ? void 0 : i[0];
                                    if (t) {
                                        let { id: e } = t;
                                        return e;
                                    }
                            ...
                            get isLegalRejected() {
                                var r;
                                if (!(0, l._n)(e) || !e.disclaimers || e.isAvailable) return !1;
                                let t = null == (r = (0, s.bRW)(e.disclaimers, L.M.MODAL)) ? void 0 : r[0];
                                return (null == t ? void 0 : t.type) === L.M.MODAL;
                            },
                            get isUnsafeLegal() {
                                if (!(0, l._n)(e)) return !1;
                                if (e.disclaimers) {
                                    var a;
                                    let t = null == (a = (0, s.bRW)(e.disclaimers, L.M.MODAL)) ? void 0 : a[0];
                                    return e.isAvailable && (null == t ? void 0 : t.type) === L.M.MODAL;
                                }
                                return !1;
                            },
                            get entityId() {
                            ...
                            get hasModalAccess() {
                                var o;
                                return !!(null == (o = e.disclaimers) ? void 0 : o.includes(L.M.MODAL));
                            },
                        };
                        return t;
                    })
                ...
                R = l.gK.model('MajorModel', { id: l.gK.number, name: l.gK.string, prettyName: l.gK.maybeNull(l.gK.string) });
            (a || (a = {})).TOO_MANY_FILES = 'TOO_MANY_FILES';
            let D = l.gK
                    .model('TrackUgcUploadModel', {
                        loadingState: l.gK.enumeration(Object.values(g)),
                        errorReason: l.gK.maybeNull(l.gK.enumeration(Object.values(m))),
                    ...
                    .actions((e) => {
                        let t = {
                            ...
                            getUploadUrl: (0, l.L3)(function* () {
                                if (!(0, l._n)(e)) return;
                                let { loaderResource: t, modelActionsLogger: i } = (0, l._$)(e),
                                    { user: r } = (0, l.Zn)(e);
                                if (![g.IDLE, g.REJECT].includes(e.loadingState)) return;
                            ...
                            uploadFile: (0, l.L3)(function* () {
                                if (!(0, l._n)(e)) return;
                                let { prefixlessResource: t, modelActionsLogger: i } = (0, l._$)(e);
                                if (e.loadingState === g.PREPARE && e.uploadUrl && e.file) {
                            ...
                            runUpload: (0, l.L3)(function* () {
                                (0, l._n)(e) && (yield t.getUploadUrl(), e.loadingState !== g.REJECT && (yield t.uploadFile()));
                            }),
                            retryUpload() {
                            ...
                            abortUpload() {
                                var t;
                                if (((e.loadingState = g.CANCELLED), null == (t = e.abortController) || t.abort(), !(0, l._n)(e))) return;
        ...
        68555: (e, t, i) => {
            ...
            var r = i(33008),
                ...
                o = i(78016);
            let u = (e) => {
                let { className: t, variant: i = 'text', onClick: u, iconClassName: d, iconSize: c, size: m = 's' } = e,
        ...
        70559: (e, t, i) => {
            ...
            let u = (e) => {
                ...
                return (0, a.c)(async (newE, actionSubtype) => {
                    ...
                    if (!e) return;
                    let n = i.modal.isOpened ? l.uQT.FULLSCREEN_INFO : l.uQT.INFO,
                        a = i.modal.isOpened ? l.uQT.FULLSCREEN_ERROR : l.uQT.ERROR;
                    return t.isAuthorized
                        ? c({ track: e, errorContainerId: a, infoContainerId: n })
                        : void u((0, r.jsx)(s.hT, { error: d({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: a });
                });
            };
        },
        75305: (e, t, i) => {
        ...
        78724: (e, t, i) => {
            ...
            let y = (0, a.PA)((e) => {
                ...
                let { className: k, id: O, albumId: L, streamProgress: T, durationMs: A, playContextParams: _, withTimeLeftText: S = !0, isFinishedLabelHidden: P } = e,
                    K = (0, m.eGp)(),
                ...
                (0, l.useEffect)(() => {
                    ...
                    let e =
                        null == K
                            ...
                            : K.state.playerState.status.onChange(() => {
                                  (null == K ? void 0 : K.state.playerState.status.value) === c.MT.BUFFERING && U(!0);
                              });
                    return () => {
                        null == e || e();
                    };
                    ...
                    (0, l.useEffect)(() => {
                        var e;
                        (null == R || null == (e = R.meta) ? void 0 : e.listeningFinished)
                            ? (T.updateEndPositionSec(0), T.updateEverFinished(!0))
                            : (null == R ? void 0 : R.allTracksUnfinished) && T.updateEverFinished(!1);
                    ...
                    (0, l.useEffect)(() => {
                        ...
                        x &&
                            ...
                            T.updateEverFinished(!!N.entityMeta.streamProgress.hasEverFinished),
                            D - ((null == T ? void 0 : T.endPositionSec) || 0) < 1 &&
                        ...
                        null == N || null == (E = N.entityMeta) || null == (a = E.streamProgress) ? void 0 : a.hasEverFinished,
                        T,
                        T.hasEverFinished,
                        T.endPositionSec,
                        D,
                ...
                let w = (x && (null == N || null == (f = N.entityMeta) || null == (y = f.streamProgress) ? void 0 : y.endPositionSec)) || T.endPositionSec,
                    ...
                    G = (0, l.useMemo)(() => {
                        var e, t, i;
                        if (
                            ((x && (null == N || null == (t = N.entityMeta) || null == (e = t.streamProgress) ? void 0 : e.hasEverFinished)) ||
                                (null == T ? void 0 : T.hasEverFinished) ||
                                (null == R || null == (i = R.meta) ? void 0 : i.listeningFinished)) &&
                            !P
                        )
                            return (0, r.jsxs)(r.Fragment, {
                                children: [
                                    (0, r.jsx)(d.Caption, {
                                        lineClamp: 1,
                                        variant: 'div',
                                        className: (0, n.$)(p().text, { [p().text_withoutTimeLeft]: !S }),
                                        children: (0, r.jsx)(s.A, { id: 'time.finished' }),
                                    }),
                                    (0, r.jsx)(u.Icon, { size: 'xxs', variant: 'check', className: p().checkIcon }),
                                ],
                            });
                        if (!w || 0 === w) return;
                        let a = D - w,
                        ...
                        return (0, r.jsxs)(r.Fragment, {
                            children: [
                                (0, r.jsx)(d.Caption, { lineClamp: 1, variant: 'div', className: (0, n.$)(p().text, { [p().text_withoutTimeLeft]: !S }), children: l }),
                                a > 1 || P
                                    ? (0, r.jsx)(o.q, { 'aria-valuetext': j, 'aria-busy': x && F, value: w, max: D })
                                    : (0, r.jsx)(u.Icon, { size: 'xxs', variant: 'check', className: p().checkIcon }),
                            ],
                        });
                    }, [
                        ...
                        x,
                        F,
                        null == N || null == (I = N.entityMeta) || null == (h = I.streamProgress) ? void 0 : h.hasEverFinished,
                        null == R || null == (b = R.meta) ? void 0 : b.listeningFinished,
                        P,
                        w,
                        j,
                    ]);
                return (0, r.jsx)('div', { className: (0, n.$)(p().root, k), children: G });
            });
        },
        79636: (e) => {
            e.exports = {
            ...
            let E = (e) => {
                ...
                return (0, d.c)(async (newE, actionSubtype) => {
                    ...
                    if (e) {
                        ...
                        if (!t.isAuthorized) return void p((0, r.jsx)(m.hT, { error: h({ id: 'authorization-messages.need-to-authorizate' }) }), { containerId: d });
                        if (y) return;
                        ...
                        if ((f(!1), b === o.f.OK)) {
                            var a;
                            p((0, r.jsx)(g.NotificationDislike, { coverUri: v.coverUri, isDisliked: v.isDisliked, title: v.title, entityVariant: I }), {
                                containerId: l,
                            });
                            let e = v.isDisliked ? u.O.DISLIKE : u.O.UNDISLIKE;
                            if (E && (0, s.i)(E.state.currentContext.value)) {
                                let t = E.state.queueState.entityList.value.find((e) => {
                                    let { entity: t } = e;
                                    return t.data.meta.id === v.id;
                                });
                                t && (await E.state.currentContext.value.sendFeedback({ type: e, entity: t.entity }));
                            }
                            v.isDisliked &&
                                v.id === (null == E || null == (a = E.state.queueState.currentEntity.value) ? void 0 : a.entity.data.meta.id) &&
                                (null == E || E.moveForward());
                        } else p((0, r.jsx)(m.hT, { error: h({ id: 'error-messages.error-during-action' }) }), { containerId: d });
                    }
                });
            };
        },
        ...
        97004: (e, t, i) => {
            ...
            var r = i(33008),
                ...
                c = i.n(d);
            let m = (e) => {
                let { coverUri: t, title: i, isDisliked: d, closeToast: m, className: g, entityVariant: v } = e,
                    E = (0, a.useMemo)(
                        () =>
                            (0, r.jsx)(s.Paper, {
                                className: c().cover,
                                radius: 's',
                                children: (0, r.jsx)(u.BW, { className: c().image, src: t, alt: i, size: 100, fit: 'cover', withAvatarReplace: !0 }),
                            }),
                        [t, i],
                    ),
                    p = (0, a.useMemo)(() => {
                        if (d)
                            switch (v) {
                                case u.cp.PODCAST_EPISODE:
                                    return (0, r.jsx)(l.A, { id: 'notifications-info.podcast-episode-unavailable-in-recommendations' });
                                case u.cp.AUDIOBOOK_EPISODE:
                                    return (0, r.jsx)(l.A, { id: 'notifications-info.audiobook-episode-unavailable-in-recommendations' });
                                default:
                                    return (0, r.jsx)(l.A, { id: 'notifications-info.track-unavailable-in-recommendations' });
                            }
                        switch (v) {
                            case u.cp.PODCAST_EPISODE:
                                return (0, r.jsx)(l.A, { id: 'notifications-info.podcast-episode-available-in-recommendations' });
                            case u.cp.AUDIOBOOK_EPISODE:
                                return (0, r.jsx)(l.A, { id: 'notifications-info.audiobook-episode-available-in-recommendations' });
                            default:
                                return (0, r.jsx)(l.A, { id: 'notifications-info.track-available-in-recommendations' });
                        }
                    }, [v, d]);
                return (0, r.jsx)(u.$W, {
                    ...
                    message: (0, r.jsxs)('div', {
                        className: c().message,
                        children: [E, (0, r.jsx)(o.Caption, { className: c().text, variant: 'div', type: 'controls', size: 'm', children: p })],
                    }),
                });
            };
        },
