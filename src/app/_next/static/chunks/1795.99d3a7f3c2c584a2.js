(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [1795],
    {
        ...
        42558: (t, e, s) => {
            ...
            class r extends a.X {
                ...
                async finishWizard(t, e) {
                    let s = (0, o.F)({ genre: t.genre, likedArtists: t.likedArtists, unlikedArtists: t.unlikedArtists });
                    await this.httpClient.post(
        ...
        42937: (t, e, s) => {
            ...
            class o extends a.X {
                async getStorageData(t, e) {
                    let { formatFlags: s, direct: i, preview: a, canUseStreaming: o, tsInSeconds: r, sign: l, debug: c, isAliceRequester: u, requireMp3Link: d } = t;
                    return (
                        await this.httpClient.get(
        ...
        43411: (t, e, s) => {
            ...
            let p = async (t) => {
                    var e, s;
                    let { options: i, error: a, retryAttempt: n, clientRetryConfig: o } = t;
            ...
            class g {
                    ...
                    if (
                        ...
                        (null == r ? void 0 : r.config) &&
                            ...
                            y.hooks.beforeRetry.push(async (t) => {
                                await p({ request: t.request, options: t.options, error: t.error, retryAttempt: t.retryCount, clientRetryConfig: r });
                            })),
                        o)
                    ) {
                        let t,
                ...
                errorConverter(t, e, s) {
                    if (t instanceof a.H || t instanceof n.M)
                        return new c.G(t.message, { statusCode: t instanceof n.M ? r.X.REQUEST_TIMEOUT : t.response.status, cause: t });
                    let i = null;
                    return (
                        e &&
                            s &&
                ...
                c = l(
                    {
                        ...
                        slidesResource: { getUserSlides: 500, getArtistSlides: 500, getPodcastSlides: 500, getSpecialSlides: 500 },
            ...
            class r {
                ...
                async request(t, e) {
                    let s,
                        ...
                        o = e.method || 'GET';
                    if ('POST' !== o)
                        throw new n.m(''.concat(o, ' method is not supported by BeaconHttpClient. navigator.sendBeacon() only supports POST requests.'), {
                            code: a.Z.METHOD_NOT_SUPPORTED,
                            cause: { method: o, supportedMethods: ['POST'] },
                        });
                ...
                async executeBeforeErrorHooks(t, e) {
                    ...
                    let a = [...this.beforeErrorHooks, ...(null != (i = null == e || null == (s = e.hooks) ? void 0 : s.beforeError) ? i : [])],
                        o = t instanceof n.m ? t : new n.m(t instanceof Error ? t.message : 'Unknown error', { cause: t });
                    for (let t of a) {
                        let e = await t(o);
                ...
                async executeWithRetries(t, e, s) {
                    ...
                    let r = null == (i = s.retry) ? void 0 : i.config,
                        l = null != (o = null == r ? void 0 : r.totalRequestsLimit) ? o : 1,
                    ...
                    for (let i = 1; i <= l; i++)
                        try {
                            if (!navigator.sendBeacon(t, e)) {
                                ...
                                if (await this.handleRetryableError(t, i, l, r)) continue;
                                throw t;
                            }
                            ...
                            if (await this.handleRetryableError(t, i, l, r, s)) continue;
                            throw t;
                        }
                    throw c;
                }
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ 'sort-by': t.sortBy, 'sort-order': t.sortOrder }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ addPlaylistWithLikes: t.addPlaylistWithLikes }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ visibility: t.visibility, title: t.title, description: t.description }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ kinds: t.kinds, withLikesCount: t.withLikesCount, withTracks: t.withTracks }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ value: t.description }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                ...
                async likeTrack(t, e) {
                    let s = await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ 'track-id': t.entityId }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        ),
                        i = await s.json();
                ...
                async likePlaylist(t, e) {
                    let s = await this.httpClient.post(
                        ...
                        this.createHttpOptions({
                            ...
                            params: t,
                            searchParams: (0, o.P)({ 'owner-uid': t.ownerId, kind: t.kindId }),
                            signal: null == e ? void 0 : e.signal,
                        }),
                    );
                    return (await s.json()) === a.f.OK ? a.f.OK : a.f.ERROR;
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ page: t.page, pageSize: t.pageSize }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                ...
                async presaveAlbum(t, e) {
                    let s = await this.httpClient.post(
                        ...
                        this.createHttpOptions({
                            ...
                            params: t,
                            searchParams: (0, o.P)({ albumId: t.albumId, likeAfterRelease: t.likeAfterRelease }),
                            signal: null == e ? void 0 : e.signal,
                        }),
                    );
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ includeReleased: t.includeReleased, includeUpcoming: t.includeUpcoming }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                    ...
                    return (
                        await this.httpClient.get(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ clientSearchContext: t.clientSearchContext, contentType: t.contentType, supportedTypes: t.supportedTypes }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({
                                ...
                                params: t,
                                searchParams: (0, o.P)({ diff: t.diff, revision: t.revision }),
                                signal: null == e ? void 0 : e.signal,
                            }),
                        )
                    ).json();
        ...
        72060: (t, e, s) => {
            ...
            class c {
                formatMessage(t, e) {
                    ...
                    return (Object.keys(l).length && (s = this.obfuscateData(l)), n) ? ''.concat(o, ' ').concat(a(s)) : [o, s];
                }
                obfuscateData(t) {
                    var e;
                    if (null == (e = this.secureFields) ? void 0 : e.length) for (let e of this.secureFields) void 0 !== (0, n.A)(t, e) && (0, o.A)(t, e, l());
                    return t;
                }
            ...
            class r extends o.X {
                ...
                async sessionNew(t, e) {
                    ...
                    return (
                        await this.httpClient.post(
                            'rotor/session/new',
                            this.createHttpOptions({ timeoutKey: 'sessionNew', params: t, json: s, signal: null == e ? void 0 : e.signal }),
                        )
                    ).json();
                }
                async sessionClone(t, e) {
                    ...
                    return (
                        await this.httpClient.post(
                            ...
                            this.createHttpOptions({ timeoutKey: 'sessionClone', params: t, json: s, signal: null == e ? void 0 : e.signal }),
                        )
                    ).json();
                }
                ...
                o = (t, e) => async (s) => {
                    ...
                    if ((0, a.N)(o) && n(s))
                        try {
                            ...
                            e instanceof i.m5 && n(e) && t.redirectToLogoutUrl();
                        }
                    return s;
                };
        },
        ...
        94753: (t, e, s) => {
            var i = {
                ...
                './qa.ts': [83591, 3591],
                './retryPolicyConfigs/musicExternalApiRetryPolicyConfig.ts': [25883],
                './retryPolicyConfigs/musicExternalApiRetryPolicyServerConfig.ts': [64328, 4328],
            ...
            class o extends a.X {
                async getPromoAlbumInfo(t, e) {
                    let s = await this.httpClient.get(
                        ...
                        this.createHttpOptions({ timeoutKey: 'getPromoAlbumInfo', params: t, signal: null == e ? void 0 : e.signal }),
                    );
                    return await s.json();
                }
